...
pub struct Frame<'w> {
    ...
    render_context: &'w mut RenderContext<'w>,
}
...
impl<'w> Frame<'w> {
    ...
    pub fn command_encoder(&mut self) -> &mut CommandEncoder {
        self.render_context.command_encoder()
    }
    ...
    pub fn swap_chain_texture(&self) -> &TextureView {
        self.view_target.out_texture()
    }

    /// The texture format of the frame's swap chain texture.
    pub fn swap_chain_texture_format(&self) -> TextureFormat {
    ...
    pub fn device(&self) -> &RenderDevice {
        &self.render_context.render_device()
    }
    ...
    pub fn color_attachment_descriptor(&self) -> RenderPassColorAttachment {
        ...
        C: Into<Color>,
    {
        ...
        let view = self.texture_view().clone();
        let pass = self
            .render_context
            .begin_tracked_render_pass(RenderPassDescriptor {
                ...
                color_attachments: &[Some(RenderPassColorAttachment {
                    ...
                    resolve_target: None,
                    ops: Operations {
                        load: LoadOp::Clear(linear_color.into()),
                        store: StoreOp::Store,
                    },
                })],
